...
//        when(activityRepository.countByCourseId(publishedCourse.getId())).thenReturn(3L);
//        when(activityRepository.countByCourseId(buildingCourse.getId())).thenReturn(5L);
//
//
//        when(instructorMapper.toInfoDTO(publishedCourse, 3L)).thenReturn(MockInstructorFactory.createPublishedCourseInfoDTO());
//        when(instructorMapper.toInfoDTO(buildingCourse, 5L)).thenReturn(MockInstructorFactory.createBuildingCourseInfoDTO());
//
//        // Act
